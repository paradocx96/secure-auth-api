...
public class UserApi {
    ...
    @Autowired
    public UserApi(UserMongoRepository userRepository, RoleMongoRepository roleRepository, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, JwtUtils jwtUtils, UserDetailsServiceImpl userDetailsServiceImpl) {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody UserRegisterDto userRegister) {
        ...
        User user = new User(userRegister.getUsername(), userRegister.getEmail(), userRegister.getContactNo(), passwordEncoder.encode(userRegister.getPassword()), userRegister.getUserType());
        ...
        return ResponseEntity.ok(new MessageRegisterDto(userRegister.getUsername(), userRegister.getEmail(), userRegister.getContactNo()));
    }
